...
<head>
    ...
    <title>Products :: Tuime - Animal Food Website Template</title>
            ...
            <div class="row">
              <div class="col-12">
                <div class="banner-product-single-style2-item">
                  <div class="thumb">
                    <a href="shop.html">
                      <img src="assets/img/shop/banner/3.webp" width="870" height="247" alt="Image-HasTech">
                    </a>
                  </div>
                  <div class="content">
              ...
              <div class="shop-widget shop-sidebar-category">
                ...
                <div class="sidebar-category">
                  <ul class="category-list mb--0">
                    <li><a href="shop.html">Accesasories <span>(5)</span></a></li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="footer-bottom-content">
              <p class="copyright">© 2022 Созданно от души<i class="fa fa-heart"></i> by MasonCoder</a></p>
              <div class="payment">
